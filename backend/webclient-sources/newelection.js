...
NewElectionPage.prototype.setLanguage = function() {
	...
	var testHtmlml = 
		'<br><br><button onclick="var r = secureRandom(16); var parser = new UAParser(); var browser = parser.getBrowser(); aalert.openTextOk(\'brws maj:\' + browser.major + \', brws.name: \' + browser.name + \', browser.version: \' + browser.version + \', os: \' + parser.getOS().name + \', r: \' + r.toString(16)); PublishOnlyTally.test();">Test</button>';
	var test2Htmlml = 
