...
if (isset($_GET['connectioncheck'])) {
	...
	print ('</head><body>');
	print ('<big><u>Verbindungstest erfolgreich.</u></big> <ul><li>Schlie&szlig;en Sie jetzt dieses Fenster und </li><li>klicken Sie in dem urspr&uuml;nglichen Fenster innerhalb des roten Balkens auf den Knopf &quot;erneut versuchen&quot;</li><ul>');
	print ('</body>');
	exit(0);
}
