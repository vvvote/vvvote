<?php
/** taken from: https://github.com/adoy/PHP-OAuth2
/**
...
class Client
{
    ...
    */
     ...
     * @return array
     */
    public function executeRequest($url, $parameters = array(), $http_method = self::HTTP_METHOD_GET, array $http_headers = null, $form_content_type = self::HTTP_FORM_CONTENT_TYPE_MULTIPART)
    {
        $curl_options = array(
        ...
        return array(
        	...
        	'raw' => $result  // only for debugging purpose
        );
    }
